...
export function Crosshair({ centreYear }: CrosshairProps) {
  ...
  return (
    <View pointerEvents="none" className="absolute inset-0 items-center">
      ...
      {/* Glow, needle and cap dot run from the pill down to the baseline */}
      <View className="absolute bottom-8 top-14 w-8 rounded-full bg-accent/10" />
      <View className="absolute bottom-8 top-14 w-0.5 bg-accent" />
